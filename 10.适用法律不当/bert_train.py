...
def main():
    ...
    parser.add_argument("--dev_path", type=str, default="./data/val.tsv",
    ...
    def evaluate(args, is_test):
        if is_test:
            ...
            dataset = read_dataset_law(args.dev_path)
    ...
    trainset = read_dataset_law(args.train_path)
    ...
    for epoch in range(1, args.epochs_num+1):
        ...
        if result > best_result:
            ...
            args.output_model_path="./model/BERT/bert_acc%.4f.bin"%(best_result*100.0)
